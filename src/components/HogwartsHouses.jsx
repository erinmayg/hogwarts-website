...
function HogwartsHouses() {
  const slytherin = {
    ...
    founderBio: (
      <>
        <span className='dropcap'>S</span>alazar Slytherin was a pure-blood
        wizard, noted for his <i>cunning</i> and
  ...
  const ravenclaw = {
    ...
    founderBio: (
      <>
        <span className='dropcap'>R</span>owena Ravenclaw was a Scottish witch
        and one of the four founders of Hogwarts School of Witchcraft and
  ...
  const gryffindor = {
    ...
    founderBio: (
      <>
        <span className='dropcap'>G</span>odric Gryffindor was an English
  ...
  const hufflepuff = {
    ...
    founderBio: (
      <>
        <span className='dropcap'>H</span>elga Hufflepuff was a Welsh witch and
        one of the four founders of Hogwarts School of Witchcraft and Wizardry.
        While the other founders chose to have special students, she accepted
        them all without preference, but the students of her house are described
        as <i> loyal</i> and <i>hard-working</i>.
      </>
    ),
    card: hufflepuffCard,
